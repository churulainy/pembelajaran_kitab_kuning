    ...
    <?php 
        ...
        if (isset($_POST['btnUbahUser'])) {
            ...
            if ($update_user) {
                ...
                echo "
                    <script>
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'User " . $email . " berhasil diubah!'
                        }).then((result) => {
                            if (result.isConfirmed) {
                                window.location.href = 'user.php';
                            }
                ...
                $log_gagal = mysqli_query($conn, "INSERT INTO log VALUES ('', 'User $email gagal diubah!', CURRENT_TIMESTAMP(), " . $dataUser['id_user'] . ")");
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Ubah User - <?= $data_user['email']; ?></h3>
                        </div>
                        <div class="col-sm-6">

<?php 
    ...
    $jml_user = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user WHERE role = 'pengguna'"));
    $jml_kitab = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM kitab"));
?>
...
<head>
    <title>Dashboard - Sistem Pembelajaran Kitab Kuning</title>
